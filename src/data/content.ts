...
/* Industrial projects, grouped by company and sorted by time (recent first).
   featured = shown on homepage */
export const projects = [
  // ---- Deep In Sight (2024 - present) ----
  { title: "3D Body Keypoint Estimation", area: "In-cabin Monitoring Unit", company: "Deep In Sight", partner: "SL / Mobase & Deep In Sight",
    years: "2026", tags: ["keypoints", "in-cabin"], featured: false,
    desc: "3D body keypoint estimation for in-cabin monitoring." },
  { title: "Monocular Depth Estimation", area: "In-cabin Monitoring Unit", company: "Deep In Sight", partner: "SL / Mobase / Mobis & Deep In Sight",
    years: "2024-2026", tags: ["depth", "in-cabin", "edge"], featured: true,
    desc: "Monocular depth estimation for in-cabin monitoring units." },
  { title: "Child Presence Estimation", area: "In-cabin Monitoring Unit", company: "Deep In Sight", partner: "SL / Mobase & Deep In Sight",
    years: "2025", tags: ["in-cabin", "safety"], featured: false,
    desc: "Child presence detection for in-cabin safety." },
  { title: "Seat Pose Estimation", area: "In-cabin Monitoring Unit", company: "Deep In Sight", partner: "SL / Mobase & Deep In Sight",
    years: "2025", tags: ["pose", "in-cabin"], featured: false,
    desc: "Seat pose estimation for in-cabin monitoring." },
  { title: "Gaze Estimation", area: "In-cabin Monitoring Unit", company: "Deep In Sight", partner: "SL / Mobase & Deep In Sight",
    years: "2024", tags: ["gaze", "DMS"], featured: false,
    desc: "Driver gaze estimation for the in-cabin monitoring unit." },

  // ---- DeltaX.ai (2022 - 2024) ----
  { title: "Level-4 ADAS Perception", area: "Pedestrian Detection, Distance & Predictive Trajectory Estimation", company: "DeltaX.ai", partner: "KADIF & DeltaX",
  ...
  { title: "In-cabin Monitoring System", area: "Automotive", company: "DeltaX.ai", partner: "42dot & DeltaX",
    years: "2024", tags: ["in-cabin", "DMS"], featured: false,
    desc: "In-cabin monitoring system development." },
  { title: "Pothole, Crack & Fallen Object Detection", area: "ADAS System", company: "DeltaX.ai", partner: "42dot & DeltaX",
    years: "2024", tags: ["detection", "ADAS"], featured: false,
    desc: "Road hazard detection (potholes, cracks, fallen objects) for ADAS." },
  { title: "Off-road ADAS", area: "ADAS System", company: "DeltaX.ai", partner: "KIA Customer Experience Team & DeltaX",
    years: "2023", tags: ["ADAS", "off-road"], featured: false,
    desc: "Off-road ADAS perception." },
  { title: "Real-time Eye Distance Estimation", area: "3D Light Field Display", company: "DeltaX.ai", partner: "Hyundai Mopic & DeltaX",
  ...
  { title: "Workers' Detection & Tracking", area: "Long-Wave Infrared Camera", company: "DeltaX.ai", partner: "Korea Railway Research Institute & DeltaX",
  ...
  // ---- CVIP Lab, Gachon University (2019 - 2022) ----
  { title: "Automatic Modulation Classification", area: "Deep Learning Signal Processing", company: "CVIP Lab · Gachon", partner: "LIG Nex1 & CVIP Lab",
  ...
  { title: "Deep Stereo Matching & Motion Deblurring", area: "Stereo Event Camera", company: "CVIP Lab · Gachon", partner: "SK hynix & CVIP Lab",
  ...
  { title: "Real-time Pupil Tracking", area: "Holographic Display Detection Engine", company: "CVIP Lab · Gachon", partner: "ETRI & CVIP Lab",
